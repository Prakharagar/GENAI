...
def main():
    ...
    if args.query:
       ...
       # query= \
        """
        Scan 10-Ks, earnings reports, and investor presentations for and give q
         quantatitive numbers for: “FTE growth,” “headcount,” “subscription volume,”
           “content output,” “guidance raised/beaten,” “divestiture,” “cost savings”
           """
        #no asnwer
        #query="extract the ticker name and company for which filing take place, extract the filing date as well"
        #no asnwer
    query =\
    """
    MMR
