...
def main():
    ...
    Your task is to carefully read the following document excerpt and
     extract only the information that is relevant to the question. 

    The excerpt may contain:
    - Textual explanations (e.g., market commentary, strategic plans, AI strategy)
    - Data tables (e.g., revenue breakdown, customer growth metrics)
    - Charts (converted to text in this format)
    - Company filing informations (e.g., ticker, company name, filing type ..etc)
    ...
    Question:
    Please identify the following Ticker , Company Name ,headcount growth, Challenge Summary , Challenge Context , Business Value , Business Value Context , Department , Adobe Solution , Filing Type , Filing Date , Source Quote , Source Section ,
    ...
    "Ticker , Company Name ,headcount growth, Challenge Summary , " \
    "Challenge Context , Business Value , Business Value Context ," \
    " Department , Adobe Solution , Filing Type , Filing Date , " \
    "Source Quote , Source Section
    """
